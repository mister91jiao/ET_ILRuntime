...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_HotfixHelper_Binding
    {
        ...
        static StackObject* GetIlrAttributeTypes_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<System.Type> @types = (System.Collections.Generic.List<System.Type>)typeof(System.Collections.Generic.List<System.Type>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
