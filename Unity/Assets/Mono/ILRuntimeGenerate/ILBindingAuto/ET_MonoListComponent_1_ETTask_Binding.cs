...
{
    unsafe class ET_MonoListComponent_1_ETTask_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ET.MonoListComponent<ET.ETTask>);
            args = new Type[]{};
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ET.MonoListComponent<ET.ETTask>.Create();
        ...
        static StackObject* get_List_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.MonoListComponent<ET.ETTask> instance_of_this_method = (ET.MonoListComponent<ET.ETTask>)typeof(ET.MonoListComponent<ET.ETTask>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
