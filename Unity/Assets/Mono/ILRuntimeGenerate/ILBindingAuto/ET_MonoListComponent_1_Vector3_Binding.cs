...
{
    unsafe class ET_MonoListComponent_1_Vector3_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ET.MonoListComponent<UnityEngine.Vector3>);
            args = new Type[]{};
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ET.MonoListComponent<UnityEngine.Vector3>.Create();
